...
# modalities: s1, s2, landsat. loss: patchdisc. Contrastive: no. EMA: yes, full exit depth
python scripts/2025_10_02_phase2/ablations/base_random_masking.py launch phase2.0_base_random_s1s2landsat_random_patchdisc_nocon_emafull ai2/jupiter --train_module.contrastive_config.weight=0.0 --train_module.loss_config.loss_config.type=patch_discrimination_new --common.training_modalities='[sentinel2_l2a,sentinel1,landsat]' --train_module.ema_decay='[0.996,1.0]' --train_module.token_exit_cfg='{"sentinel2_l2a": 12, "sentinel1": 12, "landsat": 12}' --launch.priority=urgent --trainer.callbacks.wandb.project=2025_10_08_phase2_ablations
