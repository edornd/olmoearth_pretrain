...
# MAE
python scripts/2025_10_02_phase2/ablations/base_mae.py phase2.0_base_mae ai2/ceres-cirrascale  --launch.clusters='[ai2/jupiter-cirrascale-2]' --launch.priority=normal
# random init the target projections
python scripts/2025_10_02_phase2/base.py launch phase2.0_base_random_target ai2/ceres-cirrascale  --train_module.reinit_targets=True --launch.clusters='[ai2/jupiter-cirrascale-2]' --launch.priority=normal
# original patch disc loss
python scripts/2025_10_02_phase2/base.py launch phase2.0_base_patchdisc_loss ai2/ceres-cirrascale  --train_module.loss_config.loss_config.type="patch_discrimination_new" --launch.clusters='[ai2/jupiter-cirrascale-2]' --launch.priority=normal
...
python scripts/2025_10_02_phase2/ablations/base.py phase2.0_base_no_maps ai2/ceres-cirrascale  --launch.clusters='[ai2/jupiter-cirrascale-2]' --launch.priority=high --common.training_modalities='[sentinel2_l2a,sentinel1,landsat,srtm]' --train_module.masking_config.strategy_config.only_decode_modalities='[srtm]'
# no decode modalities (removing maps + srtm)
python scripts/2025_10_02_phase2/ablations/base.py phase2.0_base_no_maps_srtm ai2/ceres-cirrascale  --launch.clusters='[ai2/jupiter-cirrascale-2]' --launch.priority=normal --common.training_modalities='[sentinel2_l2a,sentinel1,landsat]' --train_module.masking_config.strategy_config.only_decode_modalities='[]'
# no landsat
