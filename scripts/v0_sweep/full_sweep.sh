...
python scripts/v0_sweep/galileo_st.py launch test_sweep_gal_st ai2/jupiter-cirrascale --common.launch.num_gpus=8 --data_loader.token_budget=6000
python scripts/v0_sweep/galileo_st.py launch test_sweep_gal_st_no_mae ai2/jupiter-cirrascale --model.reconstructor_config=null --train_module.mae_loss_config=null --common.launch.num_gpus=8 --data_loader.token_budget=6000
